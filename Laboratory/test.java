#testing of OTP assignment using junit
...
public class Mail_OTPTest {
 ...
 // Test case to check if email is valid 
 	...
 	public void test_email_id() {
 		 ...
 		 String email = "ruddhibhagat2402@gmail.com";
 	...
 	public void test_invalid_email_id() {
 		 ...
 		 String email = "ruddhibhagat2402@gmailcom";
 		assertFalse( email.contains("@gmail.com"));
 		  if(email.contains("ruddhibhagat2402email.com"))
 				System.out.println("Test case  failed ");
 			else 
